...
from seq_queries.data import load_app_data, process_app_mooc_data
...
def main():
    ...
    args = get_args(manual_config="scripts/train/apps.yaml")
    DEVICE = args.device
    DISABLE_TQDM = args.disable_tqdm
    text_dict= load_app_data(args.data_path, args)
