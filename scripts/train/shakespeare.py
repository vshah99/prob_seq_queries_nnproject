...
from seq_queries.data import load_text_data, process_text_data
...
def main():
    ...
    args = get_args(manual_config="scripts/train/shakespeare.yaml")
    DEVICE = args.device
    DISABLE_TQDM = args.disable_tqdm
    text_dict= load_text_data(args.data_path,args)
